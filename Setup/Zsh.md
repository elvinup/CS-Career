...
To configure powerlevel10k (or just paste the ~.p10k.zsh file which is further below)
```
exec zsh
```
## Config
...
export ZSH="/Users/euthuppan/.oh-my-zsh"
...
export SDKMAN_DIR="/Users/euthuppan/.sdkman"
[[ -s "/Users/euthuppan/.sdkman/bin/sdkman-init.sh" ]] && source "/Users/euthuppan/.sdkman/bin/sdkman-init.sh"
...
centro_token(){
  docker run stoken | pbcopy
}

thycotic_qa_token(){
  docker run thycotic_qa | pbcopy
}

thycotic_xt_token(){
  docker run thycotic_xt | pbcopy
}
...
eval "$(/Users/euthuppan/.local/bin/mise activate zsh)"
```
...
```zsh
# Generated by Powerlevel10k configuration wizard on 2024-03-04 at 13:17 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_BACKGROUND=202
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_BACKGROUND=202
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_THRESHOLD=226
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=226
